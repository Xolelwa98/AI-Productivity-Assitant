  ...
  head: () => ({
    meta: [
      ...
      { title: "WorkFlow AI — AI Workplace Productivity Assistant" },
      {
        name: "description",
        content:
          "AI dashboard for professional emails, meeting summaries, task planning, research briefs and workplace chat.",
      },
      { property: "og:title", content: "WorkFlow AI — AI Workplace Productivity Assistant" },
      {
        property: "og:description",
        content: "Automate everyday workplace tasks with five AI tools in one dashboard.",
      },
